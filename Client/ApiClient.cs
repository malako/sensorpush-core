...
namespace Mrc.SensorPushCore.Client
{
    ...
    public partial class ApiClient
    {
        ...
        public ApiClient()
        {
            Configuration = Mrc.SensorPushCore.Client.Configuration.Default;
            RestClient = new RestClient("https://api.sensorpush.com/api/v1");
        }

        /// <summary>
        /// Initializes a new instance of the <see cref="ApiClient" /> class
        /// with default base path (https://api.sensorpush.com/api/v1).
        /// </summary>
        /// <param name="config">An instance of Configuration.</param>
        public ApiClient(Configuration config)
        {
            Configuration = config ?? Mrc.SensorPushCore.Client.Configuration.Default;
