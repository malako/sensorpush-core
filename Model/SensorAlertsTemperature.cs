...
namespace Mrc.SensorPushCore.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class SensorAlertsTemperature :  IEquatable<SensorAlertsTemperature>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SensorAlertsTemperature" /> class.
        /// </summary>
        ...
        public SensorAlertsTemperature(bool? enabled = default(bool?), decimal? max = default(decimal?), decimal? min = default(decimal?))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SensorAlertsTemperature {\n");
        ...
        {
            return this.Equals(input as SensorAlertsTemperature);
        }

        /// <summary>
        /// Returns true if SensorAlertsTemperature instances are equal
        /// </summary>
        /// <param name="input">Instance of SensorAlertsTemperature to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SensorAlertsTemperature input)
        {
            if (input == null)
                return false;
