...
namespace Mrc.SensorPushCore.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class SensorAlerts :  IEquatable<SensorAlerts>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SensorAlerts" /> class.
        /// </summary>
        /// <param name="humidity">humidity.</param>
        /// <param name="temperature">temperature.</param>
        public SensorAlerts(SensorAlertsHumidity humidity = default(SensorAlertsHumidity), SensorAlertsTemperature temperature = default(SensorAlertsTemperature))
        {
        ...
        public SensorAlertsHumidity Humidity { get; set; }

        /// <summary>
        /// Gets or Sets Temperature
        /// </summary>
        [DataMember(Name="temperature", EmitDefaultValue=false)]
        public SensorAlertsTemperature Temperature { get; set; }
        ...
        {
            return this.Equals(input as SensorAlerts);
        }

        /// <summary>
        /// Returns true if SensorAlerts instances are equal
        /// </summary>
        /// <param name="input">Instance of SensorAlerts to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SensorAlerts input)
        {
            if (input == null)
                return false;
